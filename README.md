...
>> - Отображаются все объявления, фактически костыль. Ожид. рез-т: все объявления, н
>> - Мои ДЖ доступны только вновь зарегистрированным пользователям. Ожид. рез-т: пользователи с группой "owner"

>### Нереализованные фичи
>> - В карточке животного не все поля объявления //Карточка животного - объявление
>> - Вид отображения (значки/таблица) ??? //Всё объявления
>> - Фильтр записывается в переменную allAdsForm, но никак не используется //Всё объявления
>> - Редизайн проекта, до +- красивого //Весь проект
>> - Блок "Мои ДЖ" нужно придумать макет, кнопки и саму карточку ДЖ //Мои ДЖ
>> - Кнопка "отображать только мои" не связана с dataTable - оставить Саше
...
| Роль | Права  |
| --------- | -----  |
| Администратор | Просмотр, удаление, изменение в рамках всех записей реестра |
| Пользователь | Просмотр всех, удаление/изменение своих записей в реестре |
