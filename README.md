...
>> - При открытии объявления открывает одно и то же объявление. Ожид. рез-т: открывает конкретное объявление из кеша
...
>> - Загрузка и хранение фотографий + настройка openfiledialog
>> - Экспорт word/excel
>> - Удаление объявлений
>> - Сохранение изменение объявлений
