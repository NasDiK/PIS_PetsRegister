...
>> - При загрузке фотографии оно не отображается в PictureBox (впринципе большая фича)
>> - При подаче объявлений фото не загружается (реализовано только при изменении)


>### Нереализованные фичи
>> - Ререндер кнопок при клике на строчку (проверка прав) //Все объявления
>> - Нет фотографии в реестре объявлений //Все объявления
...
>> - Удаление фотографий + кнопка "сделать основной"
